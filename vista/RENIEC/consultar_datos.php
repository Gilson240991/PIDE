	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-sm-8">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><b>CONSULTAR DATOS POR D.N.I.</b></li>
				</ol>
			</div>
			<div class="col-sm-4">
		...
		<form action="" class="form-horizontal">
			<div class="form-group row" style="margin-top: 10px;">
				<div class="col-sm-1">
					<label for="" class="col-form-label">Nº de D.N.I.</label>
				</div>
				<div class="col-sm-2">
					<input type="text" id ='dni' class="form-control" maxlength="8" onKeyPress="return soloNum(event)">
				</div>
				<div class="col-sm-1">
					<button type="button" class="btn btn-primary" onclick="buscardatospordni()"><i class="fa fa-search"></i> Buscar</button>
				</div>
				<div class="col-sm-1">
					<div id="loading">
