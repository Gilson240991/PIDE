      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          ...
          <ul class="sidenav-second-level collapse" id="poderjudicial">
            <li>
              <a href="navbar.html">Verificar antecedentes penales</a>
            </li>
       ...
       <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#inpe" data-parent="#exampleAccordion">
          ...
          <ul class="sidenav-second-level collapse" id="inpe">
            <li>
              <a href="navbar.html">Verificar antecedentes judiciales</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
         <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#sunarp" data-parent="#exampleAccordion">
           ...
           <ul class="sidenav-second-level collapse" id="sunarp">
            <li>
              <a href="navbar.html">Buscar titularidad</a>
            </li>
            <li>
              <a href="cards.html">Listar asientos</a>
            </li>
            <li>
              <a href="cards.html">Ver asiento</a>
            </li>
            <li>
              <a href="cards.html">Ver detalle RPV</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="migraciones">
            <li>
              <a href="navbar.html">Consultar documentos</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="MEF">
            <li>
              <a href="login.html">Obtener PIP</a>
            </li>
            <li>
              <a href="register.html">Fuentes por año</a>
            </li>
            <li>
              <a href="forgot-password.html">Proyectos por año</a>
            </li>
            <li>
              <a href="blank.html">Rubros por año</a>
            </li>
          </ul>
        </li>
